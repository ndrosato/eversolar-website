...
// Footer component with memoization for better performance
const Footer = () => {
  // Memoize the footer links to prevent unnecessary re-renders
  const footerLinks = React.useMemo<FooterLink[]>(() => [
    {
      title: "Services",
      links: [
  ...
  return (
    <footer className="bg-[#1C2C5B] text-white">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:py-16 lg:px-8">
        ...
        <div className="mt-12 border-t border-white/10 pt-8">
          <p className="text-base text-white/80">&copy; {new Date().getFullYear()} Eversolar. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
